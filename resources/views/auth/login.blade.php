...
@section('content')
    ...
    <div class="col-lg-4 col-md-6 ml-auto mr-auto">
        <form class="form" method="post" action="{{ route('login') }}">
            ...
            <div class="card card-login card-dark">
                <div class="card-header">
                    <img src="{{ asset('black') }}/img/card-primary.png" alt="">
                    <h1 class="card-title p-3">{{ __(' Login') }}</h1>
                </div>
                <div class="card-body">
                ...
                <div class="card-footer">
                    <button type="submit" href="" class="btn btn-info   animation-on-hover btn-lg btn-block mb-3">{{ __('Ingresar') }}</button>            
                </div>
            </div>
        </form>
    </div>
